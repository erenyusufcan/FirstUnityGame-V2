...
- Enemy logic and path control (Enemy Script + Manager)
...
- **Mixamo** (animations & basic model)
- **Unity Asset Store packages**
- **YouTube – Yakın Kampüs Unity Game Development Series** (main learning resource)
- Unity UI system  
...
Screenshots and gameplay video will be added after recording.
